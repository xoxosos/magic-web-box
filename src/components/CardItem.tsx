...
const Card = () => (
    <Panel className='card-item'  >
        ...
        <div className='card-item-tags'>
            ...
            <Tag size='sm' color="orange">Orange</Tag>
            <Tag size='sm' color="yellow">Yellow</Tag>
            <Tag size='sm' color="green">Green</Tag>
            <Tag size='sm' color="cyan">Cyan</Tag>
            <Tag size='sm' color="blue">Blue</Tag>
            <Tag size='sm' color="violet">Violet</Tag>
        </div>
    </Panel>
);
...
export const CardItem = () => (
    <div className="show-grid">
        <FlexboxGrid justify="start">
            <FlexboxGrid.Item as={Col} colspan={24} lg={4} md={8} sm={12}>
                <Card />
            </FlexboxGrid.Item>
            <FlexboxGrid.Item as={Col} colspan={24} lg={4} md={8} sm={12} >
                <Card />
